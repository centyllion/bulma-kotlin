...
enum class ColumnOffset(override val className: String) : HasClassName {
    None(""),
    ThreeQuarters("is-three-quarters"),
    TwoThirds("is-two-thirds"),
    Half("is-half"),
...
class Column(
    ...
    /** Column [offset](https://bulma.io/documentation/columns/sizes/#offset). */
    var offset by className(offset, root)
